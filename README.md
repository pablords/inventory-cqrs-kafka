...
Este projeto é um sistema para gerenciar produtos e seus estoques. Ele é composto por dois serviços principais:
...
**Descrição:** Remove uma quantidade do estoque de um produto existente.  
