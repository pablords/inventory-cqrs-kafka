package com.pablords.query.config;
...
public class KafkaConsumerConfig {
  ...
  public ConsumerFactory<String, StockUpdatedEvent> consumerFactory() {
      ...
      props.put(JsonDeserializer.TRUSTED_PACKAGES, "*"); // Permite desserializar qualquer pacote confiável
      props.put(JsonDeserializer.USE_TYPE_INFO_HEADERS, false); // Ignora o cabeçalho de tipo
